...
import ModalCreateTarjetas from 'components/Modals/modalcreatetarjetas';
import ModalEditTarjetas from 'components/Modals/modaledittarjetas';

const useStyles = makeStyles(styles);



export default function Tarjetastable() {
  ...
  function deleteelement(e,id2) {
      e.preventDefault();
      axios.delete(`https://criptoadviser.com/api/tarjetas/${id2}`,{ headers: {'Accept': 'application/json','Content-Type': 'application/json' }})
      .then(() => {
        asd()
        })
  ...
  return (
    ...
    >
      <ModalCreateTarjetas asd={asd} setOpen={setOpen} ></ModalCreateTarjetas>
    </form>
          </div>
        </Fade>
      </Modal>
    ...
    >
      <ModalEditTarjetas asd={asd} info={id} setOpen={setOpen2} ></ModalEditTarjetas>
    </form>
          </div>
        </Fade>
      </Modal>
