...
export default function ModalEditWallet({setOpen, asd, info}) {
    const [name,setname] = React.useState(info.name);
    const [image,setimage] = React.useState(info.image);
    ...
    async function register(e) {
       ...
       axios.put(`https://criptoadviser.com/api/wallets/${info._id}`,cosa,{ headers: {'Accept': 'application/json','Content-Type': 'application/json' }})
        .then((res) => {
