...
export default function ModalEditClase({setOpen, asd, info}) {
    ...
    async function register(e) {
        ...
        if (cosa === info.file) {
            const qwe = {
              ...
              axios.put(`https://criptoadviser.com/api/clases/${info._id}`,qwe,{ headers: {'Accept': 'application/json','Content-Type': 'application/json' }})
              .then((res) => {
