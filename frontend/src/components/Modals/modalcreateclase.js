...
export default function ModalCreateClase({setOpen, asd, }) {
    ...
    async function register(e) {
        ...
        if (cosa === "") {
          ...
          axios.post("https://criptoadviser.com/api/clases/",info,{ headers: {'Accept': 'application/json','Content-Type': 'application/json' }})
          .then((res) => {
